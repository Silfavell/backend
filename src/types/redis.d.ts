...
export interface Commands<R> {
    ...
    hdelAsync: OverloadedKeyCommand<string, number, Promise<any>>;
    HDEL: OverloadedKeyCommand<string, number, R>;
    ...
    hsetAsync(key: string, field: string, value: string, cb?: Callback<number>): Promise<R>;
    HSET(key: string, field: string, value: string, cb?: Callback<number>): R;
    ...
    lrangeAsync(key: string, start: number, stop: number, cb?: Callback<string[]>): Promise<any>;
    LRANGE(key: string, start: number, stop: number, cb?: Callback<string[]>): R;
