...
export const validatePostCategory = (category: CategoryDocument) => categorySchema.validateAsync(category)
...
export const validateUpdateCategory = (category: CategoryDocument) => categorySchema.validateAsync(category)
